(function() {
    ...
    var textOptions = {
        ...
        translate: function() {
            if (windowWidth > 1120) return {translateX: 380, translateY: 280};
    ...
    var numberOptions = {
        ...
        ty: function() { return Pieces.random(-200, 200); },
        translate: function() {
            if (windowWidth > 1120) return {translateX: -440, translateY: -280};
            if (windowWidth > 720) return {translateX: -440, translateY: -280};
